...
class ConvRec_BiLSTM(nn.Module):
    def __init__(self, text_length, embedding_size, num_embeddings, num_channels,
                 hidden_dim, num_classes, dropout_p,
                 pretrained_embeddings=None, padding_idx=0):
        """
        Args:
        ...
        _ext_width = int((((text_length - 4) / 2) - 2) / 2)

        self._extractor2 = nn.LSTM(_ext_width, num_channels, batch_first=True, bidirectional=True)
